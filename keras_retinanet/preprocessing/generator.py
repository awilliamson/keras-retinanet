...
class Generator(object):
    ...
    def check_images_annotations(self, image_group, annotations_group, group):
    ...
    def compute_input_output(self, group):
        ...
        image_group, annotations_group = self.check_images_annotations(image_group, annotations_group, group)
